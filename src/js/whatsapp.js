(function () {
    ...
    var usersWhats = [
        { Name: "MDecor", Phone: "+55 11 93210-8163", UnmaskedPhone: "5511000000000", Message: "Olá, vi seu site e gostaria de saber mais sobre os serviços da MDecor!", ButtonText: null, Photo: "public/favicon.png" },
    ];
    var usersHTML = "";
    ...
    var HTML =
        '<button class="wc--button-fab"><div class="wc--icon"><img src="public/whatsapp-brands.svg" alt="icon-chat" width="31px" /></div></button><div class="wc--float-ballon"><button class="wc-float-ballon--button-close">+</button><span class="wc--float-ballon--title">Conversar pelo WhatsApp</span><div class="wc--float-ballon--content"><p class="wc--float-ballon--text">' +
        CTA +
